  ...
  config = function()
    require("telescope").setup({
      defaults = {
        ...
        layout_config = { height = 0.75, vertical = { fname_width = 0.5 } },
      },
      extensions = {
        ["ui-select"] = {
    ...
    vim.keymap.set("n", "<leader>f;", "<CMD>Telescope notify<CR>", { desc = "Notifications" })

    vim.keymap.set("n", "<leader>lq", builtin.diagnostics, { desc = "Search diagnostics" })
